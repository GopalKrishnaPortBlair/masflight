      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="p-6 border-0 shadow-md hover:shadow-lg transition-shadow duration-300 lg:col-span-2">
          ...
          <div className="h-80 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl">
            <BarChart className="h-12 w-12 text-dashboard-400" />
            <p className="ml-4 text-dashboard-500">Chart data visualization</p>
          </div>
        </Card>
        ...
        <Card className="p-6 border-0 shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="space-y-5">
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="flex items-start pb-5 border-b border-gray-100 last:border-0 last:pb-0">
